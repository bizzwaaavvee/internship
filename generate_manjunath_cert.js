...
async function createCustomCert() {
  const name = "THAMBU MOHANA MANJUNATH";
  const email = "2400030565@kluniversity.in";
  const password = "2400030565@kluniversity.in";
  const dob = "2006-01-18";
  const domain = "fsd";
  ...
  const studentId = '2400030565'; // Given ID
  ...
  fs.writeFileSync('THAMBU_MOHANA_MANJUNATH_Certificate.pdf', pdfBytes);
  console.log("Certificate saved to THAMBU_MOHANA_MANJUNATH_Certificate.pdf");
}
