...
async function createCustomCert() {
  const name = "MARINGANTI ADITHYA";
  const email = "maringantiadithya1@gmail.com";
  const password = "maringantiadithya1@gmail.com";
  const dob = "2005-05-21";
  const domain = "fsd";
  ...
  const studentId = '2400030243'; // Given ID
  const created_at = new Date('2026-08-08T13:00:00Z').toISOString(); // Today
  ...
  fs.writeFileSync('MARINGANTI_ADITHYA_Certificate.pdf', pdfBytes);
  console.log("Certificate saved to MARINGANTI_ADITHYA_Certificate.pdf");
}
